...
# Unformtunately this one did not work, due to ffi errors
#from models.PWC_Net.PyTorch.external_packages.correlation_pytorch_master.correlation_pytorch.correlation_package.modules.corr import Correlation

# Needed to use this layer, beause of torch ffi
from models.flownet2.networks.correlation_package.correlation import Correlation
import numpy as np
...
class PWCDCNet(nn.Module):
    ...
    def __init__(self, md=4):
        ...
        # for correlation class: max_displacement=md, corr_multiply=1, stride2=1
        self.corr    = Correlation(pad_size=md, kernel_size=1, max_displacement=md, stride1=1, stride2=1, corr_multiply=1)
        #self.corr    = SpatialCorrelationSampler(padding=md, kernel_size=1, stride=1)
